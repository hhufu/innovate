  ...
  <el-dialog
    ...
    <el-row>
      <table border="1" cellspacing="0" width="100%" class="table" id="all-out-table">
          <tr align='center'>
            <td colspan="16" style="height: 1.2rem"></td>
          </tr>
        ...
        <tr align='center' v-if="matchInfoList.length === 0">
          ...
          <template>
            ...
            >
              ...
              <td>
                <span v-for="temp in matchGroupTypeList" v-if="temp.value === item.matchInfoEntity.matchGroupType" v-text="temp.label"/></td>
    ...
    methods: {
      ...
      exportDeclare () {
        this.$confirm(`确定要进行[导出项目信息]操作?`, '提示', {
          ...
          var msg = '操作成功'
          var type = 'success'
          var wb = XLSX.utils.table_to_book(document.querySelector('#all-out-table'))
