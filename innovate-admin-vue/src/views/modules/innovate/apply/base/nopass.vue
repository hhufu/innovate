<template>
  <div class="mod-user">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('innovate:project:list')" type="text" size="small" @click="retreatHandle(scope.row.projectInfoEntity.projectId)">不通过意见</el-button>
    ...
    <retreat-history v-if="retreatVisible" ref="retreat" @refreshDataList="getDataList"></retreat-history>
  </div>
</template>
...
<script>
  ...
  import RetreatHistory from './operation/retreat-history'
