  ...
  export default {
    data () {
      return {
        ...
        moneyTypeList: [
          {value: 1, label: '获得投资情况'}, {value: 2, label: '享受管理服务补助资金情况'},
          {value: 3, label: '享受房租和宽带接入补助情况'}, {value: 4, label: '享受水电费补助情况'},
          {value: 5, label: '享受一次性创业补贴情况'}, {value: 6, label: '享受吸纳就业困难群体一次性补助情况'},
          {value: 7, label: '享受社会保险补贴情况'}, {value: 8, label: '获得创业担保贷款情况'}
        ],
        awardTypeList: [
