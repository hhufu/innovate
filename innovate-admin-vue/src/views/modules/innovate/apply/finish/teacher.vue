    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="applyFinishIsVisible(scope.row.finishInfoEntity)" type="text" size="small" @click="sighingOpinionsHandle(scope.row.finishInfoEntity.finishId)">审批</el-button>
